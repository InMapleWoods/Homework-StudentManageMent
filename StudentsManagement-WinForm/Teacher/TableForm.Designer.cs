namespace StudentsManagement_winForm.Teacher
{
    partial class TableForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.courseAddControl = new StudentsManagement_winForm.Teacher.CourseAddControl(user);
            this.gradeManageControl = new StudentsManagement_winForm.Teacher.GradeManageControl();
            this.SuspendLayout();
            // 
            // courseAddControl
            // 
