...
public class CourseBll {
    ...
    public String GetStudentChosenCourse(String studentId, int index, int size) throws Exception {
        ...
        String str;
        try {
            ArrayList<String[]> temp= courseDal.GetStudentChosenCourse(studentId, index, size);
    ...
    public String GetStudentNoChooseCourse(String studentId, int index, int size) throws Exception {
        ...
        String result;
        try {
            result = ConvertArrayList(courseDal.GetStudentNoChooseCourse(studentId, index, size));
        } catch (Exception e) {
            throw e;
        }
        return result;
